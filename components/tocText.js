...
export default function TOCtext(props) {
    ...
    return (
        ...
        <div className="prose max-w-none prose-lead:text-3xl prose-h1:text-6xl mb-10 dark:prose-invert">
            ...
            <p className="lead text-center">The Second round of designs have been collected in a single click-through presentation. The table of contents below shows how the {projectInfo.frames} slides are organized.</p>
            <p><b>Overview:</b> The presentation includes mockups for the homepage, hover styles therein, nav styling, and sample interior layouts. Included in this round are also style library pages that showcase the main suite of site styles for the new design</p>
